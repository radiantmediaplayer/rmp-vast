...
var RmpVast = /*#__PURE__*/function () {
  ...
  js_createClass(RmpVast, [{
    ...
    value: function _getVastTag(vast) {
      ...
      console.log("".concat(FW.consolePrepend, " Try to load VAST tag"), FW.consoleStyle, '');
      console.log(vast);
      vastParser.parseVAST(xmlDoc).then(function (response) {
