...
export default class AdPlayer {
  ...
  destroy() {
    console.log(`${FW.consolePrepend} start destroying ad player`, FW.consoleStyle, '');
    ...
    try {
      if (this._adPlayer) {
        ...
        console.log(`${FW.consolePrepend} flushing __adPlayer buffer after ad`, FW.consoleStyle, '');
      }
      if (this._rmpVast.rmpVastNonLinearCreative) {
  ...
  init() {
    ...
    this._contentPlayer.addEventListener('ended', () => {
      ...
      this._rmpVast.__contentPlayerCompleted = true;
    });
  ...
  resumeContent() {
    console.log(`${FW.consolePrepend} AdPlayer resumeContent requested`, FW.consoleStyle, '');
    ...
    if (!this._rmpVast.__contentPlayerCompleted && !this._params.outstream) {
      console.log(
        `${FW.consolePrepend} content player play requested after ad player resumeContent`,
        FW.consoleStyle,
        ''
      );
