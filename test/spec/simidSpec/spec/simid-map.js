const ADTAG = 'https://www.radiantmediaplayer.com/vast/tags/simid-map.xml';

describe('Test for simid-map', function () {
  ...
  it('should load and play simid-map', function (done) {
    let validSteps = 0;
