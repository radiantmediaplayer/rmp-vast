...
let testUrls = [
  SELENIUM.pathToTest + 'adPodSpec/AdPodNoStandaloneSpec.html'
];

const testUrlsChromeOnly = [
  SELENIUM.pathToTest + 'adPodSpec/AdPodAllWrappers.html',
  SELENIUM.pathToTest + 'adPodSpec/AdPodErrorCreativeOnSecondAd.html',
  SELENIUM.pathToTest + 'adPodSpec/AdPodNoStandaloneSpec.html',
  SELENIUM.pathToTest + 'adPodSpec/AdPodWithStandaloneSpec.html'
];
